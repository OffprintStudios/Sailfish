<script lang="ts">
	import { LinkKinds } from "$lib/models/accounts";
	import {
		DiscordFill,
		FacebookFill,
		Link,
...
<style lang="scss">
	a.link-tag {
		@apply block flex items-center no-underline py-1 pl-1 pr-1.5 rounded-md text-white mx-0.5 first:ml-0 last:mr-0 my-0.5;
	}
</style>
