<div class="relative w-full h-[16rem] md:h-[28rem]">
    ...
    <div class="absolute bottom-0 pt-4 pb-2 flex flex-col items-center w-full bg-gradient-to-b from-transparent to-black">
        <h1 class="text-xl md:text-4xl text-white">The Brightest Star in the Night Sky</h1>
        <span class="text-lg md:text-2xl text-zinc-400 italic" style="font-family: var(--header-text);">The One About The Future</span>
