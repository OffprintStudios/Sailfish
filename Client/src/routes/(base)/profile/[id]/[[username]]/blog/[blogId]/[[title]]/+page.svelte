<script lang="ts">
    ...
    import { RiArrowUpSLine, RiArrowDownSLine, RiDiscussLine, RiEditCircleLine, RiDeleteBin2Line, RiThumbUpLine, RiThumbDownLine, RiHeartLine, RiHeartsLine, RiHeartAdd2Line, RiAlarmWarningLine } from "svelte-remixicon";
