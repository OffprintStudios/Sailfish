...
{#if $account.account && $account.currProfile && $account.currProfile.id === work.author.id}
	<form
		class="my-6 max-w-4xl mx-auto rounded-xl overflow-hidden flex flex-col bg-zinc-200 dark:bg-zinc-700 dark:highlight-shadowed"
		use:form
	>
		...
		<div class="flex border-b border-zinc-400 dark:border-zinc-500">
			...
			<div class="w-3/4 px-2.5 py-2.5 flex items-center justify-center">
				<div
					class="flex flex-col p-4 bg-green-700 bg-opacity-10 rounded-xl border border-green-500 w-[250px] h-[111px]"
				>
					<label class="mb-2">
				...
				<div
					class="flex flex-col p-4 bg-cyan-700 bg-opacity-10 rounded-xl border border-cyan-500 w-[250px] h-[111px]"
				>
					<label class="mb-2">
		...
		{#if $data.category === Category.Fanwork}
			<div class="flex border-b border-zinc-400 dark:border-zinc-500">
				...
				<div
					class="w-3/4 px-2.5 py-2.5 flex justify-center flex-wrap h-[250px] overflow-y-auto"
				>
					{#if loadingFandoms}
		...
		<div class="flex border-b border-zinc-400 dark:border-zinc-500">
			...
			<div class="w-3/4 px-2.5 py-2.5 flex items-center justify-center">
				<div
					class="flex flex-col p-4 bg-teal-700 bg-opacity-10 rounded-l-xl border border-teal-500 w-[250px]"
				>
					<label class="mb-2">
					...
					<div class="text-xs">A work in progress.</div>
				</div>
				<div
					class="flex flex-col p-4 bg-teal-700 bg-opacity-10 border-y border-teal-500 w-[250px]"
				>
					<label class="mb-2">
					...
					<div class="text-xs">Totally wrapped up.</div>
				</div>
				<div
					class="flex flex-col p-4 bg-teal-700 bg-opacity-10 border-y border-l border-teal-500 w-[250px]"
				>
					<label class="mb-2">
					...
					<div class="text-xs">Taking a break.</div>
				</div>
				<div
					class="flex flex-col p-4 bg-teal-700 bg-opacity-10 rounded-r-xl border border-teal-500 w-[250px]"
				>
					<label class="mb-2">
					...
					<div class="text-xs">Nothing more to say.</div>
				</div>
			</div>
		</div>
