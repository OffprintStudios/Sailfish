<script lang="ts">
	...
	import { TagCard } from "$lib/ui/content";
	import {
		EmotionLaughLine,
		FilePaper2Line,
		DoorClosedLine,
...
<svelte:head>
	<title>Genres &mdash; Offprint</title>
</svelte:head>
