...
impl Profile {
    ...
    pub async fn new(account_id: Uuid, new_username: String, new_bio: Option<String>, db: &sqlx::Pool<sqlx::Postgres>) -> Result<Self, SailfishError> {
        use ammonia::clean;
    ...
    pub async fn fetch_owned(account_id: Uuid, db: &sqlx::Pool<sqlx::Postgres>) -> Result<Vec<Self>, SailfishError> {
    ...
    pub async fn check_owned(profile_id: String, account_id: Uuid, db: &sqlx::Pool<sqlx::Postgres>) -> Result<Self, SailfishError> {
        let result: Self = sqlx::query_as!(
            Self,
    ...
    pub async fn fetch_one(profile_id: String, db: &sqlx::Pool<sqlx::Postgres>) -> Result<Self, SailfishError> {
        let result: Self = sqlx::query_as!(
            Self,
