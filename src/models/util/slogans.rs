pub const DEFAULT_SLOGANS: [&'static str; 55] = [
...
pub const EASTER_SLOGANS: [&'static str; 0] = [];

pub const HALLOWEEN_SLOGANS: [&'static str; 0] = [];

pub const HOLIDAY_SLOGANS: [&'static str; 0] = [];