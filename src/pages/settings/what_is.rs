...
#[server]
pub async fn render_what_is() -> Result<String, ServerFnError> {
    let to_parse = r#"
...
#[component]
pub fn WhatIs() -> impl IntoView {
    let meta_options = MetaTagOptions {
        url: "https://offprint.cafe/settings/about/what-is".to_string(),
