...
#[server]
pub async fn render_privacy_policy_page() -> Result<String, ServerFnError> {
    let to_parse = r#"
...
Offprint Studios Data Controller: Alyx Mote figments@offprint.net
...
pub fn PrivacyPolicy() -> impl IntoView {
    let meta_options = MetaTagOptions {
        url: "https://offprint.cafe/settings/about/privacy-policy".to_string(),
    ...
    view! {
        ...
        <Await
            future=render_privacy_policy_page
            blocking=true
            children=|data| {
