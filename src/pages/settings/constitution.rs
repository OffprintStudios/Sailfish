...
#[server]
pub async fn render_constitution_page() -> Result<String, ServerFnError> {
    let to_parse = r#"
...
pub fn Constitution() -> impl IntoView {
    let meta_options = MetaTagOptions {
        url: "https://offprint.cafe/settings/about/constitution".to_string(),
    ...
    view! {
        ...
        <Await
            future=render_constitution_page
            blocking=true
            children=|data| {
