...
use crate::ui::content::work_card::WorkCard;
...
pub fn CardCarousel(children: Children) -> impl IntoView {
    view! {
        <div>
            ...
            <div class="flex items-center justify-start flex-shrink-0 w-full pb-8 px-4 snap-x snap-mandatory snap-always overflow-x-scroll scrollbar-none">
