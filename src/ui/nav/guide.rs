...
use crate::ui::misc::{LinkBlock, Button as AppButton, RoleBadge};
...
#[component]
pub fn MainPanel(#[prop(into)] profile: Signal<ProfileObject>, set_curr_panel: WriteSignal<Panel>) -> impl IntoView {
    view! {
        <div class="flex flex-col items-center justify-center w-full pb-4">
            ...
            <div class="flex items-center w-full px-4">
                <img src=profile().avatar class="block w-[80px] h-[80px] object-cover rounded-full mr-2" />
                <div>
